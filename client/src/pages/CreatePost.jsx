...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      alert("Please enter a promot and generate an image");
    }
  };
        ...
        <form action="" className="mt-16 max-w-3xl " onSubmit={handleSubmit}>
          ...
          <div className="mt-5 flex gap-5">
            <button
              ...
              className="text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto py-2.5 text-center px-2  "
            >
          ...
          <div className="mt-10 ">
            ...
            <button
              type="submit"
              className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-2 py-2.5 text-center"
            >
